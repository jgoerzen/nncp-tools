...
- Helps me understand how important, or not, this service is
...
- news.quux.org calls quux public relay to exchange packets at :25 and :55.  This will cause inbound packets to be processed.
- NNCP outgoing batches are generated at :30 and :00.
- news.quux.org calls quux again ast :35 and :05 to transmit those outgoing batches.
